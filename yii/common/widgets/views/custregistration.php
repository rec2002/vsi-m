    ...
    <div class="row row10">
        <div class="col-sm-6 col-lg-7">
            <div class="simple-input-icon">
                <?= $form->field($model, 'location')->textInput(['value'=>@Yii::$app->session['newCustomerSession']['location'], 'class' => 'simple-input light', 'tabindex' => '3', 'autocomplete'=>'off', 'placeholder' => "Львів", 'style' => 'margin-bottom: 0px;'])->label(false); ?>
            </div>
        </div>

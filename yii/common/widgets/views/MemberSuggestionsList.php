...
<div class="tabs-block style-2 large suggestion-list">
    <div class="tab-nav">
        <div class="tab-menu active">Пропозиції <span class="count-large">(<? $i=0; foreach ($models as $model) if ($model->disregast_suggestion==0) $i++; echo $i;?>)</span></div>

<? $i=0; foreach ($models as $model) if ($model->disregast_suggestion>0) $i++; ?>
<? if ($i>0) { ?>
...
<? foreach ($models as $model) if ($model->disregast_suggestion==0){ ?>
                        ...
                        <div class="tab-entry" style="display: block;">
                            <div class="tab-entry-box">
                                ...
                                <div class="phone-number-block">
                                    ...
                                    <a href="#" class="button type-1 size-3 phone-number-show open-popup" data-rel="15">Показати номер</a>
                                    <a class="tt-icon-entry tt-icon-hover openChatButton" href="user-messages.html">

...
<? if (sizeof($ratings[$model->member->id])) { ?>
                    <div class="tt-proposition-reviews simple-text size-2">
                        <p><?=sizeof($ratings[$model->member->id])?> <?=MemberHelper::NumberSufix(sizeof($ratings[$model->member->id]), array('відгук', 'відгуки', 'відгуків'))?></p>
                    </div>
<? } ?>
                ...
                <div class="tt-proposition-content">
                    <div class="tabs-block style-1">
                        <div class="tab-nav">
                            ...
                            <div class="tab-menu"><span>Відгуки (<?=sizeof($ratings[$model->member->id])?>)</span></div>
                        </div>
...
<? foreach ($ratings[$model->member->id] as $key=>$val) {?>

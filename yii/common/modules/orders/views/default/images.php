...
<? foreach ($images as $val) {?>
                <div class="swiper-slide">
                    <div class="tt-project-preview swiper-lazy" data-background="/uploads/members/orders/<?=$val->image?>">
...
<? if (sizeof($images)>1)  foreach ($images as $val) {?>
            <div class="swiper-slide">
                <div class="tt-project-thumb">
                    <img src="/uploads/members/orders/thmb/<?=$val->image?>" style="height: 67px;" alt="">
                </div>
            </div>
<? } ?>
        </div>

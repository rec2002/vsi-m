...
<? if (in_array($this->context->action->id, array('suggested'))) { ?>
                            <div class="tt-order-filter-wrapper">
                                <div class="tabs-block style-2">
                                    <div class="tab-nav">
                                        <div class="tab-menu redirect tab-fadeout <?=(((Yii::$app->getRequest()->getQueryParam('status'))==false) ? 'active' : '' )?>"><a href="<?=Url::to(['/orders/default/suggested'])?>">Надіслані мною пропозиції <span class="count-large">(<?=$count_total['status_0']?>)</span></a></div>
                                        <div class="tab-menu redirect tab-fadeout <?=(((Yii::$app->getRequest()->getQueryParam('status'))==1) ? 'active' : '' )?>"><a href="<?=Url::to(['/orders/default/suggested', 'status'=>1])?>">Підтримані пропозиції замовником <span class="count-large">(<?=$count_total['status_1']?>)</span></a></div>

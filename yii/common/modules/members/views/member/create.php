                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        $form = ActiveForm::begin(['id' => 'add-order',
                            ...
                            'validationUrl'=>Url::toRoute('/members/member/validation/?mode=add-order'),
                            'action' =>['/members/member/orderadd/'],
                                                ...
                                                <div class="tt-input-wrapper style-2">
                                                    ...
                                                    <div class="tt-input-entry">
                                                        <div class="simple-input-icon">
                                                            ...
                                                            <?= $form->field($order, 'date_from')->textInput(['class' => 'simple-input simple-datapicker', 'autocomplete'=>'off',  'data-min-date'=>'0',  'placeholder' => "Виберіть дату", 'style' => 'margin-bottom: 0px;'])->label(false); ?>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="tt-input-wrapper style-2">
                                                    ...
                                                    <div class="tt-input-entry">
                                                        <div class="simple-input-icon">
                                                            <img src="data:image/png;base64," alt="" style="top: 28px;">
                                                            <?= $form->field($order, 'date_to')->textInput(['class' => 'simple-input simple-datapicker', 'autocomplete'=>'off',  'data-min-date'=>'0',  'placeholder' => "Виберіть дату", 'style' => 'margin-bottom: 0px;'])->label(false); ?>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

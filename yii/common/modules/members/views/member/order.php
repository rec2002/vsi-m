            ...
            <div class="tt-task detail">
                            ...
                            <li>
                                <div class="tt-task-feature tt-editable-wrapper slide-anim">
                                    ...
                                    $form4 = ActiveForm::begin(['id' => 'edit_location',
                                        ...
                                        'validationUrl'=>Url::toRoute('/members/member/validations/?mode=location&id='.$model->id),
                                        'action' =>['/members/member/saveorder/?mode=location&id='.$model->id],
                            ...
                            <li>
                                <div class="tt-task-feature tt-editable-wrapper slide-anim">
                                    ...
                                    $form3 = ActiveForm::begin(['id' => 'edit_budget',
                                        'options' => ['class'=>'form-edit-order-ajax'],
                                        'enableAjaxValidation'=>true,
                                        'validationUrl'=>Url::toRoute('/members/member/validations/?mode=budget&id='.$model->id),
                                        'action' =>['/members/member/saveorder/?mode=budget&id='.$model->id],
                            ...
                            <li>
                                <div class="tt-task-feature tt-editable-wrapper slide-anim">
                                    ...
                                    $form5 = ActiveForm::begin(['id' => 'edit_when_start',
                                        'options' => ['class'=>'form-edit-order-ajax'],
                                        'enableAjaxValidation'=>true,
                                        'validationUrl'=>Url::toRoute('/members/member/validations/?mode=when_start&id='.$model->id),
                                        'action' =>['/members/member/saveorder/?mode=when_start&id='.$model->id],
                ...
                <div class="tt-editable-wrapper fade-anim">
                    ...
                    $form1 = ActiveForm::begin(['id' => 'edit_descriptions',
                        'options' => ['class'=>'form-edit-order-ajax'],
                        'enableAjaxValidation'=>true,
                        'validationUrl'=>Url::toRoute('/members/member/validations/?mode=descriptions&id='.$model->id),
                        'action' =>['/members/member/saveorder/?mode=descriptions&id='.$model->id],
                ...
                <div class="tt-project-new-img tt-task-gal-edit">
                    <div class="button-upload tt-icon-hover tt-img-upload">
                        ...
                        Додати зображення
                        <input type="file" name="file" data-source="<?=Url::to(['/members/member/imageorder', 'id'=>$model->id])?>" accept="image/x-png,image/gif,image/jpeg">
                    </div>

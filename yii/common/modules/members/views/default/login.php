                        ...
                        <div class="row row130">
                            <div class="col-sm-6">
                                <form>
                                    ...
                                    <div class="empty-space marg-xs-b30 marg-lg-b35"></div>
                                    <a href="#" class="button type-1 btn-social"><span>вхід через facebook</span></a>
                                </form>
                                <div class="empty-space marg-xs-b30"></div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="simple-text size-2 blue-links small-space">
                                    ...
                                    <p><a href="master-register.html">Зареєструватись як майстер</a> - якщо шукаєте замовлення</p>
                                </div>
                            </div>
                        </div>
                        <div class="empty-space marg-sm-b40 marg-lg-b90"></div>

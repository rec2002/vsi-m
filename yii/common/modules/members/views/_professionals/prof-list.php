                                    ...
                                    <? if (sizeof($val['list'])) { ?>
                                        <ul <?=($val['active']==1) ? 'style="display: block;"' : '' ?>>
                                            <? foreach ($val['list'] as $key=>$val_)  { ?>
                                                <li><a <?=$val_['active']==1 ? 'style="color:#ff8a00"' : '' ?> href="<?=Url::to(['/members/professionals',  'region'=>Yii::$app->request->get('region'), 'cat'=>$val_['url_tag']])?>"  ><?=$val_['name']?></a></li>
                                            <? } ?>
                        ...
                        <div class="tt-masterbox">
                            <div class="tt-masterbox-top clearfix">
                                <div class="tt-masterbox-img">
                                    ...
                                    <a class="custom-hover round" href="<?=Url::toRoute(['/members/professionals/profile', 'id' => $val['id']])?>"><img src="<?=($val['avatar_image']) ? $val['avatar_image'] : '/img/person/person.png' ?>" width="136" alt=""></a>
                                </div>
                                <div class="tt-masterbox-top-right">
                                    <div class="tt-masterbox-topinfo">
                                        <a class="tt-masterbox-title h5" href="<?=Url::toRoute(['/members/professionals/profile', 'id' => $val['id']])?>"><?=(!empty($val['company']) && $val['forma']==3) ? $val['company'] : $val['last_name'].' '.$val['first_name'].' '.$val['surname'] ?></a>
...
<? } ?>
                            ...
                            <div class="tt-masterbox-desc simple-text size-3 blue-links">
                                <p><?= Html::encode( mb_strimwidth($val['about'], 0, 300, '...')); ?> <a class="tt-masterbox-more" href="<?=Url::toRoute(['/members/professionals/profile', 'id' => $val['id']])?>">Дізнатись більше</a></p>
                            </div>

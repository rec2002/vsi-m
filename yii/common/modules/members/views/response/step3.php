                        ...
                        <div class="tt-radio-switch">
                            ...
                            <div class="tt-radio-switch-content">
                                ...
                                <div class="tt-radio-switch-item finish <?=($model->stage==2) ? 'active' : ''?>" >
                                    ...
                                    <div class="simple-text size-3 space7">
                                        <p><b>Ваш відгук (буде опублікований на сторінці майстра и на вашій особистій сторінці)</b></p>
                                        <p>Будь ласка, будьте ввічливі і коректні, інакше відгук буде відхилений без провірки</p>
                                    </div>
                                    <div class="empty-space marg-lg-b30"></div>

...
<div class="tt-banner type-6 wth-swicher background-block" style="background-image:url(/img/imgblock/banner_19.jpg);">
    <div class="container">
        <div class="tt-swicher">
            <a class="active" href="/site/howitwor">Замовник</a>
            <a href="/site/howitworkmaster">Виконавець</a>
        </div>
...
<div class="tt-bg-grey">
    ...
    <div class="container">
        ...
        <div class="simple-text size-3">
            ...
            <p>Fusce in volutpat est. Quisque mattis nunc arcu, eu dignissim sem interdum sit amet. Integer viverra arcu vel efficitur aliquet. Maecenas id finibus ex, id dictum metus. Maecenas augue ex, rutrum nec turpis sed, porta faucibus velit. Vestibulum rutrum dui eu mauris rutrum interdum. Etiam consequat, tellus at rhoncus feugiat, ante neque porta elit, sit amet malesuada sem justo sit amet diam. Integer nec hendrerit orci. Nam ultricies imperdiet diam, eu viverra odio feugiat vitae. Pellentesque vulputate sapien vel metus viverra laoreet.</p>

            <p>Donec eu sodales diam, nec porttitor justo. Integer aliquet elit ante. Nunc rutrum interdum arcu at aliquet. Aenean rutrum aliquet eleifend. Donec in vulputate tellus. Mauris non sapien a erat faucibus vulputate sed sed magna. Mauris tempor commodo elit ac ultrices. Proin cursus orci nec auctor laoreet. Pellentesque facilisis lectus at fermentum lacinia. Duis bibendum tellus a risus vulputate, eu lacinia arcu sodales.</p>

            <p>Fusce eleifend viverra lobortis. Nullam pulvinar justo libero, ac ultrices velit dignissim a. In in eros ac nisi placerat eleifend quis vitae purus. Cras pretium mi vel leo mollis, eu vehicula nibh pellentesque. Praesent in elementum risus. Donec eget suscipit mi, a laoreet ante.</p>
        </div>
        <div class="empty-space marg-sm-b40 marg-lg-b75"></div>
        ...
        <div class="col-sm-4">
            <div class="tt-service type-3 grey">
                <div class="tt-service-entry">
                    ...
                    <a class="tt-service-title h5" href="register.html">Зареєструйтесь на сайті</a>
                    <div class="simple-text size-3">
...
<div class="tt-bg-grey">
    <div class="container">
        ...
        <div class="accordeon">
            ...
            <div class="accordeon-title">
                <div class="accordeon-icon"></div>Що робити, коли є скарги на виконавця?
            </div>
            <div class="accordeon-toggle">
                <div class="simple-text size-3">
                    <p>Morbi bibendum hendrerit felis, ac consequat sapien viverra vel. Fusce nunc tellus, pulvinar vitae congue ac, hendrerit sit amet lorem. Nullam bibendum venenatis varius. Donec fringilla erat quis rhoncus mollis. Nunc non consectetur ante, in viverra ipsum.</p>
...
<div class="container">
    ...
    <div class="empty-space marg-lg-b30"></div>
    <div class="text-center">
        <a href="new_task_1.html" class="button type-1 size-4 color-3 uppercase">додати замовлення</a>
    </div>

            ...
            <div class="col-sm-4">
                <div class="tt-service type-3">
                    <div class="tt-service-entry">
                        ...
                        <a class="tt-service-title h5" href="<?=Url::to(['/members/customregistration/create'])?>">Добавте замовлення</a>
            ...
            <div class="col-sm-4">
                <div class="tt-service type-3">
                    <div class="tt-service-entry">
                        ...
                        <a class="tt-service-title h5" href="<?=Url::to(['/site/category'])?>">Оберіть майстра</a>
                        <div class="simple-text size-3">

...
<div class="tt-bg-grey">
            ...
            <div class="col-sm-4">
                <div class="tt-service type-3">
                    <div class="tt-service-entry">
                        ...
                        <a class="tt-service-title h5" href="<?=Url::to(['/members/customregistration/create'])?>">Додайте замовлення</a>
            ...
            <div class="col-sm-4">
                <div class="tt-service type-3">
                    <div class="tt-service-entry">
                        ...
                        <a class="tt-service-title h5" href="<?=Url::to(['/members/login'])?>">Отримуйте пропозиції з цінами</a>
                        <div class="simple-text size-3">
            ...
            <div class="col-sm-4">
                <div class="tt-service type-3">
                    <div class="tt-service-entry">
                        ...
                        <a class="tt-service-title h5" href="<?=Url::to(['/site/category'])?>">Виберіть майстра</a>
                        <div class="simple-text size-3">
    ...
    <div class="container">
        ...
        <div class="simple-text size-4 darker text-center">
            <p>Безкоштовно для замовника. Без комісії для виконавця. <a href="<?=Url::to(['site/whywe'])?>">Економія на роботах 20-60%.</a></p>
        </div>
        <div class="empty-space marg-sm-b30 marg-lg-b35"></div>
    </div>
    <div class="tt-devider"></div>
...
<?=\common\widgets\RegionList::widget() ?>

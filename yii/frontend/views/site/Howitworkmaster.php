...
<div class="tt-banner type-6 wth-swicher background-block" style="background-image:url(/img/imgblock/banner_18.jpg);">
    <div class="container">
        ...
        <h2 class="tt-banner-title h2 small light">РЕМОНТНО-БУДІВЕЛЬНІ ЗАМОВЛЕННЯ БЕЗ ПОСЕРЕДНИКІВ</h2>
        <div class="row">
...
<div class="container">
    ...
    <div class="row vertical-middle">
        ...
        <div class="col-sm-7 col-sm-pull-5">
            <div class="tt-imgbox-info style-2">
                <a class="tt-imgbox-title h4" href="javascript:">З чого почати</a>
                <div class="simple-text size-3">
    ...
    <div class="row vertical-middle">
        ...
        <div class="col-sm-7">
            <div class="tt-imgbox-info style-2">
                <a class="tt-imgbox-title h4" href="javascript:">Наші переваги</a>
                <div class="simple-text size-3">
                    <p>
                    <ul class="list-item type-3">
                        <li>Ви обираєте замовлення яке подобається Вам.</li>
                        <li>Перед початком роботи можете ознайомитись з інформацією про замовника. Перечитавши відгуки про нього зробити висновок щодо його добросовісності.</li>
                        <li>Ви володієте інформацією про бюджет данного замовлення.</li>
                        <li>Вам не потрібно чекати на замовлення або шукати їх. Якщо Ваш професійний рівень та ціни відповідать ринку, то Ви завжди їх знайдете, або ринок запропонує їх сам.</li>
                        <li>Відсутність комісій та платежів на сайті.</li>
